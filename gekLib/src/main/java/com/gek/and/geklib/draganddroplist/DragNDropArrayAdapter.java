...
package com.gek.and.geklib.draganddroplist;
...
public class DragNDropArrayAdapter<T> extends ArrayAdapter<T> implements DragNDropAdapter {
	private int mPosition[];
	private int mHandler;
	private List<T> dataList;
	private boolean positionChanged = false;

	public DragNDropArrayAdapter(Context context, List<T> data, int handler) {
